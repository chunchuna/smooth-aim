...
// V11 raw output [1, 4+nc, num_anchors], anchors are contiguous within each channel.
// Three paths: AVX2 (8/iter) -> SSE4.1 (4/iter) -> Scalar.
void DMLYoloV11Detector::GenerateProposals(float* output, std::vector<DMLObject>& proposals, float conf) {
